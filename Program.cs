    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            while (numberNotFound)
            {
                ...
                currentLimit = (upperLimit + lowerLimit) / 2;
                // покажем ее пользователю...
                Console.WriteLine("Это цифра " + currentLimit + "?");
                // и спросим его ввод:
                ...
                switch (userInput)
                {
                    ...
                    case "yes":
                        ...
                        Console.WriteLine("Ура, цифра была " + currentLimit + "! Спасибо за игру!");
                        // и устанавливаем переменную "цифра не найдена" в false (чтоб выйти из цикла)
                        numberNotFound = false;
                        break; // все остальные случаи (cases) не проверяем - нет смысла :)
                    ...
                    default:
                        ...
                        Console.WriteLine("Не понимаю ввод. Допустимый ввод yes, less, more.");
                        // и запустим цикл по новой!
                        continue;

                        
                        // Остановим программу попросив нажать любую кнопку, просто чтоб прочитать еще раз весь вывод.                       
